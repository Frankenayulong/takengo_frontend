<div class="row">
    <ul class="c-content-pagination c-square c-theme pull-right">
        ...
        <li ng-class="carsCollectionCtrl.current_page == ($index + 1) ? 'c-active' : ''" ng-repeat="item in range(carsCollectionCtrl.last_page) track by $index"><a href="javascript:;" ng-click="changePage($index+1)">@{{$index + 1}}</a></li>
