    ...
    <div class="row c-margin-b-40 c-order-history-2">
        ...
        <div class="row c-cart-table-row" style="margin-left:0!important;margin-right:0!important;">
            ...
            <div class="col-md-2 col-sm-6 col-xs-6 c-cart-total">
                ...
                <p style="margin:0"><a href="javascript:;" data-toggle="modal" data-target="#extendModal" data-refid="#{{$item->ohid}}-end-date" data-ohid="{{$item->ohid}}" data-cid="{{$item->cid}}" data-uid="@{{metadata.auth.uid}}" data-end="{{$item->end_date}}" class="c-font-blue">Extends</a></p>
                @endif
                <p id="{{$item->ohid}}-extends-optional" style="margin:0;display:none;"><a href="javascript:;" data-toggle="modal" data-target="#extendModal" data-refid="#{{$item->ohid}}-end-date" data-ohid="{{$item->ohid}}" data-cid="{{$item->cid}}" data-uid="@{{metadata.auth.uid}}" data-end="{{$item->end_date}}" class="c-font-blue">Extends</a></p>
            </div>
